...
Route::group([
    ...
    /* ================== Static_pages ================== */
    Route::resource(config('laraadmin.adminRoute') . '/static_pages', 'StaticPagesController');
    Route::get(config('laraadmin.adminRoute') . '/static_page_dt_ajax', 'StaticPagesController@dtajax');

    /* ================== Banners ================== */
    Route::resource(config('laraadmin.adminRoute') . '/banners', 'BannersController');
    Route::get(config('laraadmin.adminRoute') . '/banner_dt_ajax', 'BannersController@dtajax');

    /* ================== Notice_boards ================== */
    Route::resource(config('laraadmin.adminRoute') . '/notice_boards', 'NoticeBoardsController');
    Route::get(config('laraadmin.adminRoute') . '/notice_board_dt_ajax', 'NoticeBoardsController@dtajax');
});
