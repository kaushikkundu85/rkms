...
@section('htmlheader_title')
    @lang('la_static_page.static_page_view')
@endsection
...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $static_page->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Static_pages", "edit")
                <a @ajaxload href="{{ url(config('laraadmin.adminRoute') . '/static_pages/'.$static_page->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Static_pages", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.static_pages.destroy', $static_page->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a @ajaxload href="{{ url(config('laraadmin.adminRoute') . '/static_pages') }}" data-toggle="tooltip" data-placement="right" title="@lang('la_static_page.back_to_static_pages')"><i class="fa fa-chevron-left"></i></a></li>
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
                        @la_display($module, 'content_title')
						@la_display($module, 'cms_content')
