...
@section('htmlheader_title')
    @lang('la_notice_board.notice_board_view')
@endsection
...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $notice_board->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Notice_boards", "edit")
                <a @ajaxload href="{{ url(config('laraadmin.adminRoute') . '/notice_boards/'.$notice_board->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Notice_boards", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.notice_boards.destroy', $notice_board->id], 'method' => 'delete', 'style'=>'display:inline']) }}
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a @ajaxload href="{{ url(config('laraadmin.adminRoute') . '/notice_boards') }}" data-toggle="tooltip" data-placement="right" title="@lang('la_notice_board.back_to_notice_boards')"><i class="fa fa-chevron-left"></i></a></li>
    ...
    <div class="tab-content">
            ...
            <div class="tab-content">
                <div class="panel infolist">
                    ...
                    <div class="panel-body">
                        @la_display($module, 'notice_title')
						@la_display($module, 'notice_date')
						@la_display($module, 'notice_details')
						@la_display($module, 'pdf_notice')
						@la_display($module, 'custom_url')
						@la_display($module, 'news_flash')
						@la_display($module, 'exam_notice')
						@la_display($module, 'status')
						@la_display($module, 'new_news')
                    </div>
                </div>
            </div>
        </div>
        <div role="tabpanel" class="tab-pane fade in p20 bg-white" id="tab-timeline">
            @php
            $timeline = $notice_board->timeline();
            @endphp
            @if(count($timeline) > 0)
