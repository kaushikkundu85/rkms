...
return [
    ...
    */
    ...
    'log' => [
        ...
        // Static_pages
        'Static_pages' => [
            'STATIC_PAGE_CREATED' => ["name" => "Static page Created", "is_notif" => "false", "code" => "STATIC_PAGE_CREATED", "module" => "Static_pages"],
            'STATIC_PAGE_UPDATED' => ["name" => "Static page Updated", "is_notif" => "false", "code" => "STATIC_PAGE_UPDATED", "module" => "Static_pages"],
            'STATIC_PAGE_DELETED' => ["name" => "Static page Deleted", "is_notif" => "false", "code" => "STATIC_PAGE_DELETED", "module" => "Static_pages"],
        ],

        // Banners
        'Banners' => [
            'BANNER_CREATED' => ["name" => "Banner Created", "is_notif" => "false", "code" => "BANNER_CREATED", "module" => "Banners"],
            'BANNER_UPDATED' => ["name" => "Banner Updated", "is_notif" => "false", "code" => "BANNER_UPDATED", "module" => "Banners"],
            'BANNER_DELETED' => ["name" => "Banner Deleted", "is_notif" => "false", "code" => "BANNER_DELETED", "module" => "Banners"],
        ],

        // Notice_boards
        'Notice_boards' => [
            'NOTICE_BOARD_CREATED' => ["name" => "Notice board Created", "is_notif" => "false", "code" => "NOTICE_BOARD_CREATED", "module" => "Notice_boards"],
            'NOTICE_BOARD_UPDATED' => ["name" => "Notice board Updated", "is_notif" => "false", "code" => "NOTICE_BOARD_UPDATED", "module" => "Notice_boards"],
            'NOTICE_BOARD_DELETED' => ["name" => "Notice board Deleted", "is_notif" => "false", "code" => "NOTICE_BOARD_DELETED", "module" => "Notice_boards"],
        ],
